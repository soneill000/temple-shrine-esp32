// hw.h — badge pin map and screen geometry.
...
// --- Piezo buzzer (MOSFET-driven, ~4 kHz resonance) ---
...
// --- Other CS pins on the shared bus; parked high on boot ---
